...
export function generatePlanFromAssessment(result: AssessmentResult): {
  ...
  return {
    ...
    description: `Personalized 4-week plan targeting ${result.limitingFactor.toLowerCase()} based on your assessment results. Generated by Session's assessment engine.`,
    focus,
    workouts,
  };
}
